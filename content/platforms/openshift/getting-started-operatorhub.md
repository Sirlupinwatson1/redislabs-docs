...
This process creates databases that are exposed as Kubernetes services
so that they are accessible by other application workloads in your K8s cluster.
...
Lifecycle Management](https://docs.openshift.com/container-platform/4.3/operators/olm-adding-operators-to-cluster.html#olm-installing-from-operatorhub-using-web-console_olm-adding-operators-to-a-cluster). The Redis Enterprise subscription that provides this is only for a single project. You cannot select **All namespaces on the cluster**.
